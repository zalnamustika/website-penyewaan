...
<head>
    ...
    <title>Admin Area - Rumah Penyewaan Pakaian</title>
...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <button type="button" class="btn btn-success nav-link" data-bs-toggle="modal"
                            data-bs-target="#cetakLaporanModal">
                        ...
                        @if (Auth::user()->role == 2)
                            <a class="nav-link {{ Route::is('superuser.admin') ? 'active' : '' }}"
                        ...
                        <a class="nav-link {{ Route::is('kategori.index') ? 'active' : '' }}"
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Rumah Penyewaan Pakaian</div>
                        <div>
    ...
    <div class="modal fade" id="cetakLaporanModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
